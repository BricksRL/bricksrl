...
from utils import create_transition_td, login, logout, prefill_buffer, tensordict2dict
...
def run(cfg: DictConfig) -> None:
    ...
    if agent.do_pretrain:
        ...
        agent.pretrain(
            wandb, batch_size=cfg.agent.batch_size, num_updates=cfg.agent.num_updates
        )
