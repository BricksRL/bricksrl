...
while True:
    ...
    left_action_value, right_action_value, speed_lm, speed_rm = ustruct.unpack(
        "!ffff", data
    )
    ...
    out_msg = ustruct.pack(
        "!ffff", normalize_angle(left), normalize_angle(right), roll, x_angl_vel
    )
