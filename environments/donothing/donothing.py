...
class DoNothingEnv(BaseEnv):
    ...
    def reward(self,
        ...
        """ Reward function of DoNothingEnv.

            Goal: Learn to take no action.
    ...
    def step(self, action: np.ndarray)-> Tuple[np.ndarray, float, bool, dict]:
        ...
        time.sleep(0.9) # we need to wait some time for sensors to read and to 
